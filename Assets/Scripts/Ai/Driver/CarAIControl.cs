    ...
    public class CarAIControl : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            ...
            else
            {
                ...
                if (m_Rigidbody.velocity.magnitude > 9999f)
                {
                    fwd = m_Rigidbody.velocity;
                }

                float desiredSpeed = 9999f;
                ...
                float accel = Mathf.Clamp((desiredSpeed - m_Rigidbody.velocity.magnitude)*accelBrakeSensitivity, -1, 1);
                ...
                float steer = Mathf.Clamp(targetAngle*m_SteerSensitivity, -1, 1)*Mathf.Sign(m_Rigidbody.velocity.magnitude);

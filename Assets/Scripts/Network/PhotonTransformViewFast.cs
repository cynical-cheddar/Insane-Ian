...
namespace Photon.Pun
{
    ...
    [AddComponentMenu("Photon Networking/Photon Transform View Fast")]
    [HelpURL("https://doc.photonengine.com/en-us/pun/v2/gameplay/synchronization-and-state")]
    public class PhotonTransformViewFast : MonoBehaviourPun, IPunObservable
    {
        ...
        public void Update()
        {
            ...
            if (!this.photonView.IsMine)
            {
                ...
                {
                    tr.localPosition = Vector3.MoveTowards(tr.localPosition, this.m_NetworkPosition, this.m_Distance * (10.0f / PhotonNetwork.SerializationRate));
                    tr.localRotation = Quaternion.RotateTowards(tr.localRotation, this.m_NetworkRotation, this.m_Angle * (10.0f / PhotonNetwork.SerializationRate));
                }
                else
                {
                    tr.position = Vector3.MoveTowards(tr.position, this.m_NetworkPosition, this.m_Distance * (10.0f / PhotonNetwork.SerializationRate));
